...
//-----------------------------------------------------------------------------------
// Implementation of the JMIN surface residual templated function in CTensorProduct.
//-----------------------------------------------------------------------------------


template<size_t K, size_t M>
void CTensorProduct<K, M>::ResidualSurfaceJMIN
(
 const size_t     N,
 const as3double *B,
 ...
 /*
	* Function that computes the residual via a tensor product on the JMIN surface integration points.
	*/
{
