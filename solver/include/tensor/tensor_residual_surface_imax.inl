...
//-----------------------------------------------------------------------------------
// Implementation of the IMAX surface residual templated function in CTensorProduct.
//-----------------------------------------------------------------------------------


template<size_t K, size_t M>
void CTensorProduct<K, M>::ResidualSurfaceIMAX
(
 const size_t     N,
 const as3double *B,
 ...
 /*
	* Function that computes the residual via a tensor product on the IMAX surface integration points.
	*/
{
