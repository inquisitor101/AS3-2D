...
(
 ...
 /*
	* Function that computes the volume terms for a given element. 
	*/
{
	...
	auto& physical_element = mPhysicalElementContainer[iElem];
...
void CEESolver::ComputeSurfaceResidualJDir_NEW
(
 const CZoneGeometry       *grid_zone,
 CPoolMatrixAS3<as3double> &workarray,
 as3double                  localtime,
